...
TREES: dict[str, list[Node]] = {
    "p1-c1": [
        ...
        n(
            "p1-c1-temporal-general",
            "Promises of Temporal Blessings in General",
            3,
            5,
            "II",
            end_marker="Particularly of Food",
            curated=[
                ("Philippians", 4, 19),
                ("1 Timothy", 6, 6),
                ("1 Timothy", 6, 17),
        ...
        n(
            ...
            8,
            "IV",
            start_marker="Long Life and Health",
            end_marker="V. Promises of Safety",
            exclude=[
                ("Proverbs", 3, 26),
                ("Psalms", 103, 3),
            ],
            children=[
                n(
                    ...
                    5,
                    7,
                    start_marker="IV. Promise of Long",
                    end_marker="all thine Health",
                    exclude=[
                        ("Psalms", 34, 1),
                        ("Proverbs", 3, 26),
                        ("Proverbs", 9, 2),
        ...
        n(
            ...
            11,
            "V",
            start_marker="V. Promises of Safety",
            exclude=[
                ("Proverbs", 4, 22),
                ("Psalms", 116, 8),
                ("1 Peter", 3, 2),
